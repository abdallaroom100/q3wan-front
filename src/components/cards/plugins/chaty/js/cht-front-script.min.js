...
function close_chaty_contact_form(t) {
        ...
        n.length && (t("body").append('<svg width="39" height="39" viewBox="0 0 39 39" class="hide-cht-svg-bg" fill="none" xmlns="http://www.w3.org/2000/svg"><defs> <linearGradient id="linear-gradient" x1="0.892" y1="0.192" x2="0.128" y2="0.85" gradientUnits="objectBoundingBox"> <stop offset="0" stop-color="#4a64d5"/> <stop offset="0.322" stop-color="#9737bd"/> <stop offset="0.636" stop-color="#f15540"/> <stop offset="1" stop-color="#fecc69"/> </linearGradient> <linearGradient id="linear-gradient-insta-dm" x1="0.892" y1="0.192" x2="0.128" y2="0.85" gradientUnits="objectBoundingBox"> <stop offset="0" stop-color="#4A64D5"></stop> <stop offset="0.322" stop-color="#9737BD"></stop> <stop offset="0.636" stop-color="#F15540"></stop> <stop offset="1" stop-color="#FECC69"></stop> </linearGradient></defs>'), t.each(n, (function(e, a) {
                ...
                y && (s ? function() {
                    if (window.history && window.history.pushState && y) {
                        function e() {
                            y && "" !== location.hash.split("#!/")[1] && "" === window.location.hash && z()
                        }
                        var a = 100;
                    ...
                    function e(t, e, a) {
                        t.addEventListener ? (t.addEventListener(e, a, !1), z()) : t.attachEvent && t.attachEvent("on" + e, a)
                    }
                    e(document, "mouseout", (function(t) {
                        null == t.toElement && null == t.relatedTarget && z()
                    }))
    ...
    function j(a) {
            ...
            if (!Q(c)) {
                ...
                if (i && (t("#" + c).addClass("is-active"), t("#" + c).length)) {
                    ...
                    if ("on" == chaty_settings.data_analytics_settings) {
                        ...
                        if (G(a, "v-" + d) && void 0 !== d && (N(a, "v-" + d), l.push(d)), !h && l.length) {
        ...
        if (g) {
            ...
            if (t("#chaty-widget-" + a + " .chaty-widget").hasClass("has-single")) p = 1, d = t("#chaty-widget-" + a + " .chaty-channel").data("channel"), G(a, "v-" + d) && void 0 !== d && (N(a, "v-" + d), l.push(d));
                ...
                d = t(this).data("channel"), G(a, "v-" + d) && void 0 !== d && (N(a, "v-" + d), l.push(d))
            })));
            if (g && !h) {
                                ...
                                var h = function(e, a, c, n, i, o) {
                                    ...
                                    if ("Whatsapp" == a.channel_type) {
                                        ...
                                        if (!Q(e.pre_set_message)) {
                                            ...
                                            var y = t("title").text();
                                            r = (r = Q(y) ? r.replace(/{title}/g, "") : r.replace(/{title}/g, y)).replace(/{url}/g, window.location), r = encodeURIComponent(r)
                                        }
                                        s ? (l = "", h = "https://wa.me/" + d + "?text=" + r) : (l = "_blank", h = q(e.use_whatsapp_web) ? "https://web.whatsapp.com/send?phone=" + d + "&text=" + r : "https://wa.me/" + d + "?text=" + r)
            ...
            if (q(e.has_welcome_message)) e.url = "javascript:;", e.target = "", i += " has-chaty-box chaty-whatsapp-btn-form",
                function(e, a) {
                    ...
                    var l = "https://web.whatsapp.com/send",
                        d = "";
                    s ? l = "https://wa.me/" + e.value : (l = q(e.is_use_web_version) ? "https://web.whatsapp.com/send" : "https://wa.me/" + e.value, d = "_blank");
                    ...
                    var r = Q(e.wp_popup_headline) ? "" : e.wp_popup_headline;
    ...
    t(document).ready((function() {
        ...
        a.test(c) && (h = !0), s ? t("body").addClass("cht-in-mobile") : t("body").addClass("cht-in-desktop"), q(chaty_settings.has_chatway) && t("body").addClass("csaas-has-chatway"), "undefined" == typeof chaty_settings ? (console.log("Chaty settings doesn't exists"), chatyInterval = setInterval((function() {
        ...
        })), t(document).on("click", ".iubenda-cs-accept-btn, .iubFooterBtn #wt-cli-privacy-save-btn, #wt-cli-accept-all-btn", (function() {
            R("chaty_cookie_accepted", !0, 365), b(), t(".chaty").addClass("active")
        })), t(document).on("click", ".iubenda-cs-reject-btn", (function() {
            ...
            if (e) {
                ...
                }(e).consent ? (R("chaty_cookie_accepted", !0, 365), b(), t(".chaty").addClass("active")) : (R("chaty_cookie_accepted", !1, 365), t(".chaty.active").removeClass("active"))
            }
        }))
